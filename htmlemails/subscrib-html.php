...
<style type="text/css">
    ...
    padding:0;
    font-family: 'KoHo', 'Script MT bold';}
...
<table width="100%" border="0" cellspacing="0" cellpadding="20" >
   <thead>
       ...
       <p style="font-size:2em; margin: 0 0 2px 0;">Your Subscription Is Successful </p>
       </th>
       <tbody background="https://toniastore.com/toniastore/img/hair3.jpg" >
           <td style=" min-height:700px;"><p style="color:#fff; font-size:1.3em; border: 1px solid #fff; width:50%; margin:50px auto; padding:30px;">You will now be the first to get our lates and beautiful products.<br><br>
           <a style="color:#fff;" href="https://toniastore.com">Explore.</a>
        </p></td>
       </tbody>
   </thead>
   <table width="100%" border="0" cellspacing="0" cellpadding="20" >
